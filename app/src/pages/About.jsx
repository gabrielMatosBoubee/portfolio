...
function About () {
  ...
  return (
    ...
    <h1 style={{ 'marginTop': '10px'}}>Whos is I?</h1>
    <p style={{ 'marginTop': '10px'}}>I am a person who want challenges, the one whose'll undestand the pain of the client
      and become the solucion on codes! But now I'll tell you my history. I start to learn
